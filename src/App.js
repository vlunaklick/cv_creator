	...
	render() {
		...
		let experienceButton = this.state.experience.map(item => {
			return (
				<ExperienceMain
					key={item.id}
					deleted={this.deleteExperience}
					opcion={this.changeExperience}
					id={item.id}
				/>
			)
		})
			...
			<div className='App'>
				...
				<div className='containers'>
					...
					<div className='main'>
						...
						{educationalButton}
						<button onClick={() => this.addEducation()} className='buttonAdd'>
							Add
						</button>

						<h1 className='educationalInfo'>Experience</h1>
						{experienceButton}
						<button onClick={() => this.addExperience()} className='buttonAdd'>
							Add
						</button>
					</div>
				</div>
